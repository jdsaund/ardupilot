...
/// @file	AP_MotorsCompound.h
/// @brief	Motor control class for Compound Heli

#ifndef __AP_MOTORS_COMPOUND_H__
#define __AP_MOTORS_COMPOUND_H__
...
#define AP_MOTORS_COMPOUND_NUM_SWASHPLATE_SERVOS    3

// servo output rates
#define AP_MOTORS_COMPOUND_SPEED_DEFAULT            125     // default servo update rate for helicopters
#define AP_MOTORS_COMPOUND_SPEED_DIGITAL_SERVOS     125     // update rate for digital servos
...
#define AP_MOTORS_COMPOUND_SERVO1_POS               -60
#define AP_MOTORS_COMPOUND_SERVO2_POS                60
#define AP_MOTORS_COMPOUND_SERVO3_POS               180

// swash type definitions
#define AP_MOTORS_COMPOUND_SWASH_CCPM               0
#define AP_MOTORS_COMPOUND_SWASH_H1                 1

// default swash min and max angles and positions
#define AP_MOTORS_COMPOUND_SWASH_ROLL_MAX           2500
#define AP_MOTORS_COMPOUND_SWASH_PITCH_MAX          2500
#define AP_MOTORS_COMPOUND_COLLECTIVE_MIN           1250
#define AP_MOTORS_COMPOUND_COLLECTIVE_MAX           1750
#define AP_MOTORS_COMPOUND_COLLECTIVE_MID           1500

// swash min and max position while in stabilize mode (as a number from 0 ~ 100)
#define AP_MOTORS_COMPOUND_MANUAL_COLLECTIVE_MIN    0
#define AP_MOTORS_COMPOUND_MANUAL_COLLECTIVE_MAX    100

// swash min while landed or landing (as a number from 0 ~ 1000
#define AP_MOTORS_COMPOUND_LAND_COLLECTIVE_MIN      0

// tail types
#define AP_MOTORS_COMPOUND_TAILTYPE_SERVO                   0
#define AP_MOTORS_COMPOUND_TAILTYPE_SERVO_EXTGYRO           1
#define AP_MOTORS_COMPOUND_TAILTYPE_DIRECTDRIVE_VARPITCH    2
#define AP_MOTORS_COMPOUND_TAILTYPE_DIRECTDRIVE_FIXEDPITCH  3

// default external gyro gain (ch7 out)
#define AP_MOTORS_COMPOUND_EXT_GYRO_GAIN            350

// minimum outputs for direct drive motors
#define AP_MOTOR_COMPOUND_DDTAIL_DEFAULT       500


// main rotor speed control types (ch8 out)
#define AP_MOTORS_COMPOUND_RSC_MODE_NONE            0       // main rotor ESC is directly connected to receiver, pilot controls ESC speed through transmitter directly
#define AP_MOTORS_COMPOUND_RSC_MODE_CH8_PASSTHROUGH 1       // main rotor ESC is connected to RC8 (out), pilot desired rotor speed provided by CH8 input
#define AP_MOTORS_COMPOUND_RSC_MODE_SETPOINT        2       // main rotor ESC is connected to RC8 (out), desired speed is held in RSC_SETPOINT parameter

// default main rotor speed (ch8 out) as a number from 0 ~ 1000
#define AP_MOTORS_COMPOUND_RSC_SETPOINT             500

// default main rotor ramp up time in seconds
#define AP_MOTORS_COMPOUND_RSC_RAMP_TIME            1       // 1 second to ramp output to main rotor ESC to full power (most people use exterrnal govenors so we can ramp up quickly)
#define AP_MOTORS_COMPOUND_RSC_RUNUP_TIME           10      // 10 seconds for rotor to reach full speed
#define AP_MOTORS_COMPOUND_TAIL_RAMP_INCREMENT      5       // 5 is 2 seconds for direct drive tail rotor to reach to full speed (5 = (2sec*100hz)/1000)

// motor run-up time default in 100th of seconds
#define AP_MOTORS_COMPOUND_MOTOR_RUNUP_TIME         500     // 500 = 5 seconds

// flybar types
#define AP_MOTORS_COMPOUND_NOFLYBAR                 0
#define AP_MOTORS_COMPOUND_FLYBAR                   1

class AP_HeliControls;

/// @class      AP_MotorsCompound
class AP_MotorsCompound : public AP_Motors {
public:

    /// Constructor
    AP_MotorsCompound( RC_Channel&      rc_roll,
                   RC_Channel&      rc_pitch,
                   ...
                   uint16_t         loop_rate,
                   uint16_t         speed_hz = AP_MOTORS_COMPOUND_SPEED_DEFAULT) :
    ...
    // get_rsc_mode - gets the rotor speed control method (AP_MOTORS_COMPOUND_RSC_MODE_NONE, AP_MOTORS_COMPOUND_RSC_MODE_CH8_PASSTHROUGH or AP_MOTORS_COMPOUND_RSC_MODE_SETPOINT)
...
private:
    ...
    // internal variables
    float           _rollFactor[AP_MOTORS_COMPOUND_NUM_SWASHPLATE_SERVOS];
    float           _pitchFactor[AP_MOTORS_COMPOUND_NUM_SWASHPLATE_SERVOS];
    float           _collectiveFactor[AP_MOTORS_COMPOUND_NUM_SWASHPLATE_SERVOS];

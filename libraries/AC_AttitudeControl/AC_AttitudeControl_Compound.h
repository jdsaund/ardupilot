...
/// @brief   ArduCopter attitude control library for compound helicopters

#ifndef AC_ATTITUDECONTROL_COMPOUND_H
#define AC_ATTITUDECONTROL_COMPOUND_H

#include <AC_AttitudeControl.h>
#include <AC_HELI_PID.h>
#include <Filter.h>

#define AC_ATTITUDE_COMPOUND_ROLL_FF                    0.0f
#define AC_ATTITUDE_COMPOUND_PITCH_FF                   0.0f
#define AC_ATTITUDE_COMPOUND_YAW_FF                     0.0f
#define AC_ATTITUDE_COMPOUND_RATE_INTEGRATOR_LEAK_RATE  0.02f
#define AC_ATTITUDE_COMPOUND_RATE_FF_FILTER             5.0f

class AC_AttitudeControl_Compound : public AC_AttitudeControl {
public:
    AC_AttitudeControl_Compound( AP_AHRS &ahrs,
                        const AP_Vehicle::MultiCopter &aparm,
                        AP_MotorsCompound& motors,
	...
	void use_leaky_i(bool leaky_i) {  _flags_compound.leaky_i = leaky_i; }
    
    // use_flybar_passthrough - controls whether we pass-through control inputs to swash-plate
	void use_flybar_passthrough(bool passthrough) {  _flags_compound.flybar_passthrough = passthrough; }
...
private:
    ...
    struct AttControlCompoundFlags {
...
#endif //AC_ATTITUDECONTROL_COMPOUND_H
